...
public class CharFilter implements InputFilter {
    ...
    public CharFilter(Context context, int maxlen, TextFilterListener listener) {
        this.MAX_LEN = maxlen;
    ...
    public CharFilter reject(String... regex) {
        ...
        return CharFilter.this;
    }


    public CharFilter ignore(char[] ignores) {
        this.ignores = ignores;
        return CharFilter.this;
    }

    public CharFilter ignoreExtraSpace(boolean ignore) {
